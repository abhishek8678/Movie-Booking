...
import heroImage from "../../assets/wp2411645-theatre-wallpapers.jpg";
      ...
      <div className={bannerStyles.content}>
        <div className={bannerStyles.contentInner}>
          ...
          <p className={bannerStyles.description}>
            Book tickets for the latest blockbusters, discover upcoming releases,
watch trailers, and experience cinema like never before.
Your next movie night starts here.
          ...
          <div className={bannerStyles.ratingGenreContainer}>
            ...
            <div className={bannerStyles.genreText}>Latest Movies • Trailers • Book Instantly</div>
          </div>
