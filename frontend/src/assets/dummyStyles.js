...
export const bannerStyles = {
  // Container styles
  container: "relative overflow-hidden h-[640px] sm:h-[760px] md:h-screen bg-cover bg-center bg-no-repeat",
...
export const navbarStyles = {
  ...
  nav: {
    ...
    scrolled: "py-3 bg-blue-950/80 backdrop-blur-md shadow-xl rounded-3xl border border-blue-500/20",
    notScrolled: "py-4 bg-blue-950/80 backdrop-blur-md rounded-full border border-blue-500/20"
  },
  ...
  logoIconContainer: "bg-blue-950 p-3 rounded-full border border-blue-400",
  ...
  // Desktop navigation
  desktopNav: "hidden lg:flex absolute left-1/2 transform -translate-x-1/2 z-10 items-center bg-blue-950/70 backdrop-blur-md rounded-full px-3 py-2 gap-2 shadow-inner border border-blue-500/20",
...
export const bookingsPageStyles = {
  ...
  title: "text-3xl md:text-4xl font-extrabold text-blue-500",
  subtitle: "text-sm text-gray-400",
  
  // Loading and error states
  loading: "py-12 text-center text-gray-400",
  error: "py-3 text-center text-blue-300",
  noBookings: "col-span-full text-center text-gray-400 py-8 border border-blue-800 rounded-lg",
  
  // Grid layout
  grid: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",
  
  // Booking card
  bookingCard: "bg-gradient-to-b from-gray-900 to-black rounded-2xl p-4 border border-blue-800 shadow-xl",
  cardContent: "flex flex-col lg:flex-row items-start gap-4",
  posterContainer: "w-full lg:w-24 h-44 lg:h-36 flex-shrink-0 overflow-hidden rounded-md border border-blue-700",
  poster: "w-full h-full object-cover",
  cardInfo: "flex-1 w-full",
  cardHeader: "flex items-start justify-between gap-3",
  movieTitle: "text-lg font-bold text-blue-400 flex items-center gap-2",
  movieIcon: "w-5 h-5",
  ...
  timeIcon: "w-4 h-4 text-blue-300",
  locationContainer: "flex items-center gap-2 mt-2 sm:mt-0",
  locationIcon: "w-4 h-4 text-blue-300",
  ...
  // Expanded details
  expandedDetails: "mt-4 border-t border-blue-900/40 pt-3 text-sm text-gray-300 space-y-3 transition-all duration-200 ease-in-out",
  ...
  seatItem: "px-3 py-1 rounded-md bg-black/40 border border-blue-800 flex items-center gap-2 text-sm",
  seatId: "font-semibold",
  seatType: "text-xs px-2 py-0.5 rounded",
  seatTypeRecliner: "bg-blue-700 text-white",
  ...
  detailsButton: "inline-flex items-center gap-2 px-3 py-2 rounded-lg border border-blue-700 bg-black/30 hover:bg-black/40 transition",
  ...
  modalContent: "relative max-w-md w-full bg-gray-900 rounded-2xl p-6 border border-blue-800 shadow-2xl text-gray-100",
  modalHeader: "flex items-start justify-between gap-4",
  modalTitle: "text-xl font-bold text-blue-400",
...
export const trailersStyles = {
  ...
  controlButton: "p-2 rounded-full bg-gray-100 hover:bg-blue-100 text-blue-600 transition-colors",
  ...
  playButton: "bg-blue-600 hover:bg-blue-700 cursor-pointer rounded-full p-4 md:p-5 transition-all transform ",
